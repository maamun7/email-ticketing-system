...
class Users extends CI_Model {
	...
	{ 	
        ...
        $this->db->where(array('username'=>$username,'password'=>$password,'is_active'=>'1','can_login'=>'1','user_type'=>'2'));
	...
	{
		$user_name = md5("onexam".$new_password);
		$password = md5("onexam".$old_password);
