			...
			<div class="panel-body">
                 <form role="form" id="send_mail_form" action="{action}" method="POST">
                    <div class="col-lg-12"> 
                        ...
                        <div class="<?php if ($cc_email_value =='') { echo "cc-field";} ?> ">
                            <input name="cc_email" id="cc_email" value="<?php if (isset($cc_email_value)) { echo $cc_email_value; } ?>" class="emai_field" placeholder="CC">
                        </div>
                        <div class="bcc-field">
                            <input name="bcc_email" id="bcc_email" value="Re:<?php if (isset($bcc_email_value)) { echo $bcc_email_value; } ?>" class="emai_field" placeholder="BCC">
                        </div>
                    ...
                    <div class="col-lg-12">
					<hr>
					<b>From:</b> {from_email_id} <br/>
					<b>To:</b> {to_email_id} <br/>
